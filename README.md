...
- **VideoAnchor**: Reinforcing Subspace-Structured Visual Cues for Coherent Visual-Spatial Reasoning [Paper](https://openreview.net/forum?id=2JLPQbHABc)
- When would Vision-Proprioception Policies Fail in Robotic Manipulation? [Paper](https://openreview.net/forum?id=2RIqqNqALN)
- **DVLA-RL**: Dual-Level Vision–Language Alignment with Reinforcement Learning Gating for Few-Shot Learning [Paper](https://openreview.net/forum?id=2ix1K6zPRf)
...
- **MOBODY**: Model-Based Off-Dynamics Offline Reinforcement Learning [Paper](https://openreview.net/forum?id=7c0YS3cuno)
...
- **VideoZoomer**: Reinforcement-Learned Temporal Focusing for Long Video Reasoning [Paper](https://openreview.net/forum?id=ARHCFvgx6G)
...
- **MetaSpatial**: Reinforcing 3D Spatial Reasoning in VLMs for the Metaverse [Paper](https://openreview.net/forum?id=EdQzLC0Zra)
...
- **From Assumptions to Actions**: Turning LLM Reasoning into Uncertainty-Aware Planning for Embodied Agents [Paper](https://openreview.net/forum?id=GODFBZhFcX)
- 3D Aware Region Prompted Vision Language Model [Paper](https://openreview.net/forum?id=GTpf2NuwtR)
- **Gen-DFL**: Decision-Focused Generative Learning for Robust Decision Making [Paper](https://openreview.net/forum?id=GU2197a3Lm)
...
- **ContextIF**: Enhancing Instruction-Following through Context Reward [Paper](https://openreview.net/forum?id=IuscGSmfEf)
...
- **VidBridge-R1**: Bridging QA and Captioning for RL-based Video Understanding Models with Intermediate Proxy Tasks [Paper](https://openreview.net/forum?id=K7SdrTobcY)
...
- Discrete Compositional Generation via General Soft Operators and Robust Reinforcement Learning [Paper](https://openreview.net/forum?id=MGWk2tEgLW)
...
- **ChronoEdit**: Towards Temporal Reasoning for In-Context Image Editing and World Simulation [Paper](https://openreview.net/forum?id=MbMzoQ91Gk)
...
- **Video-STAR**: Reinforcing Open-Vocabulary Action Recognition with Tools [Paper](https://openreview.net/forum?id=NBOHB6aYZh)
...
- **GUI-Shift**: Enhancing VLM-Based GUI Agents through Self-supervised Reinforcement Learning [Paper](https://openreview.net/forum?id=NakMHPljT7)
- **ARM-FM**: Automated Reward Machines via Foundation Models for Compositional Reinforcement Learning [Paper](https://openreview.net/forum?id=OBpQdCWLfd)
...
- **BEAT**: Visual Backdoor Attacks on VLM-based Embodied Agents via Contrastive Trigger Learning [Paper](https://openreview.net/forum?id=OwinX7PI83)
...
- **Seeing, Listening, Remembering, and Reasoning**: A Multimodal Agent with Long-Term Memory [Paper](https://openreview.net/forum?id=PMz29A7Muq)
...
- Unified Multi-Modal Interactive and Reactive 3D Motion Generation via Rectified Flow [Paper](https://openreview.net/forum?id=QaAgHKbJop)
...
- **InfBaGel**: Human-Object-Scene Interaction Generation with Dynamic Perception and Iterative Refinement [Paper](https://openreview.net/forum?id=TeyHNq4WlI)
...
- **MedVR**: Annotation-Free Medical Visual Reasoning via Agentic Reinforcement Learning [Paper](https://openreview.net/forum?id=cK35kNVm5r)
...
- **RLVMR**: Reinforcement Learning with Verifiable Meta-Reasoning Rewards for Robust Long-Horizon Agents [Paper](https://openreview.net/forum?id=cTbAevdwBE)
...
- A Primer on SO(3) Action Representations in Deep Reinforcement Learning [Paper](https://openreview.net/forum?id=g4ZrpMQL1Z)
...
- **CoAct-1**: Computer-using Multi-agent System with Coding Actions [Paper](https://openreview.net/forum?id=l1MQVgIKEU)
...
- **AlphaSAGE**: Structure-Aware Alpha Mining via GFlowNets for Robust Exploration [Paper](https://openreview.net/forum?id=zRKF4ln2VE)
...
- **ConsisDrive**: Identity-Preserving Driving World Models for Video Generation by Instance Mask [Paper](https://openreview.net/forum?id=zgqFQM8VNe)# ICLR2026
